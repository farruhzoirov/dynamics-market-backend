...
import {AddCategoryDto, DeleteCategoryDto, GetCategoryDto, UpdateCategoryDto} from "./dto/category.dto";
...
export class CategoryController {
  ...
  async getCategoriesList(@Body() body: GetCategoryDto, @Body('parentId', ValidateObjectIdPipe) parentId: string) {
    return await this.categoryService.getCategoriesList(body);
  }

  @Post('add')
  @Roles(UserRole.superAdmin, UserRole.admin)
  async addCategory(@Body() body: AddCategoryDto, @Body('parentId', ValidateObjectIdPipe) parentId: string) {
  ...
  @HttpCode(HttpStatus.OK)
  @Roles(UserRole.superAdmin, UserRole.admin)
  async deleteCategory(@Body() body: DeleteCategoryDto, @Body('_id', ValidateObjectIdPipe) _id: string) {
